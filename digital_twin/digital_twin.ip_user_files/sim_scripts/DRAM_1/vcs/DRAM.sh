...
#
# Script generated by Vivado on Sun May 18 00:06:52 CST 2025
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../digital_twin.gen/sources_1/ip/ILA_DRAM/hdl/verilog" \
  ...
  vlogan -work dist_mem_gen_v8_0_14 $vlogan_opts +v2k +incdir+"../../../../digital_twin.gen/sources_1/ip/ILA_DRAM/hdl/verilog" \
  "../../../ipstatic/simulation/dist_mem_gen_v8_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../digital_twin.gen/sources_1/ip/ILA_DRAM/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mingzhenjia/Complex-CPU-Design-Based-on-RISC-V/digital_twin/digital_twin.cache/compile_simlib/vcs"
  fi
