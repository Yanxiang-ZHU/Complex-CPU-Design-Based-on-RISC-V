...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../digital_twin.gen/sources_1/ip/ILA_DRAM/hdl/verilog" \
  ...
  xmvlog -work dist_mem_gen_v8_0_14 $xmvlog_opts +incdir+"../../../../digital_twin.gen/sources_1/ip/ILA_DRAM/hdl/verilog" \
  "../../../ipstatic/simulation/dist_mem_gen_v8_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../digital_twin.gen/sources_1/ip/ILA_DRAM/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mingzhenjia/Complex-CPU-Design-Based-on-RISC-V/digital_twin/digital_twin.cache/compile_simlib/xcelium"
  fi
